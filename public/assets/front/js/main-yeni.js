...
if (document.getElementById('selectbox1')) {
  var demo1 = new BVSelect({
    ...
    searchbox: false,
    offset: false,
    // placeholder: document.getElementById('selectbox1').getAttribute('data-lang'),
    placeholder: document.getElementById('selectbox1').dataset.lang.toUpperCase(),
  });
}
...
//   alert(document.getElementById('counter-btn-counter').value);
// }
