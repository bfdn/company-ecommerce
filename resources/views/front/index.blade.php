...
@section('title')
    {{ config('app.name') . ' Anasayfa' }}
@endsection

@section('meta')
    <meta name="description" content="Anasayfa">
    <meta name="keywords" content="Eticaret, Anasayfa">
@endsection
@section('css')
@endsection
@push('style')
...
@section('content')
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="banner__wrapper-img banner__wrapper--img-01">
                                    <img src="{{ asset('assets/front/images/banner/banner-lg-03.jpg') }}" alt="banner" />
                ...
                <div class="col-lg-4">
                    <div class="banner__wrapper-img-sm">
                        <div class="banner__wrapper-img banner__wrapper--img-02">
                            <img src="{{ asset('assets/front/images/banner/banner-sm-05.png') }}" alt="banner" />
                        ...
                        <div class="banner__wrapper-img banner__wrapper--img-03">
                            <img src="{{ asset('assets/front/images/banner/banner-sm-04.png') }}" alt="banner" />
    ...
    <section class="popular-categories section section--md">
        <div class="container">
            <div class="section__head">
                <h2 class="section--title-one font-title--sm">{{ __('front.popular_categories') }}</h2>
            </div>
            <!-- Desktop Versions -->
            <div class="popular-categories__wrapper">
                @foreach ($popularCategories as $popularCategory)
                    @php
                        $slug = implode('/', $popularCategory->ancestors->map(fn($item, $key) => $item->slug)->all());
                        if ($popularCategory->parent_id != null) {
                            $slug .= '/';
                        }
                        $slug .= $popularCategory->slug;
                    @endphp
                    <a href="{{ route('front.categoryProductList', $slug) }}"
                        class="cards-sm popular-categories__wrapper-item">
                        <div class="cards-sm__img-wrapper">
                            <img src="{{ asset($popularCategory->image) }}" alt="{{ $popularCategory->name }}" />
                        </div>
                        <h5 class="font-body--xl-500">{{ $popularCategory->name }}</h5>
                    </a>
                @endforeach
            </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a href="# " class="cards-sm popular-categories__wrapper-item">
                            <div class="cards-sm__img-wrapper">
                                <img src="{{ asset('assets/front/images/categories/image-fruits.png') }}"
                                    alt="img-01" />
                            </div>
                    ...
                    <div class="swiper-slide">
                        <a href="# " class="cards-sm popular-categories__wrapper-item">
                            <div class="cards-sm__img-wrapper">
                                <img src="{{ asset('assets/front/images/categories/image-icon-vegitables.png') }}"
                                    alt="img-01" />
                            </div>
                    ...
                    <div class="swiper-slide">
                        <a href="# " class="cards-sm popular-categories__wrapper-item">
                            <div class="cards-sm__img-wrapper">
                                <img src="{{ asset('assets/front/images/categories/image-meat.png') }}" alt="img-01" />
                            </div>
                    ...
                    <div class="swiper-slide">
                        <a href="# " class="cards-sm popular-categories__wrapper-item">
                            <div class="cards-sm__img-wrapper">
                                <img src="{{ asset('assets/front/images/categories/image-icon-snaks.png') }}"
                                    alt="img-01" />
                            </div>
                    ...
                    <div class="swiper-slide">
                        <a href="# " class="cards-sm popular-categories__wrapper-item">
                            <div class="cards-sm__img-wrapper">
                                <img src="{{ asset('assets/front/images/categories/img-12.png') }}" alt="img-01" />
                            </div>
                    ...
                    <div class="swiper-slide">
                        <a href="# " class="cards-sm popular-categories__wrapper-item">
                            <div class="cards-sm__img-wrapper">
                                <img src="{{ asset('assets/front/images/categories/image-icon-beauty.png') }}"
                                    alt="img-01" />
                            </div>
                    ...
                    <div class="swiper-slide">
                        <a href="# " class="cards-sm popular-categories__wrapper-item">
                            <div class="cards-sm__img-wrapper">
                                <img src="{{ asset('assets/front/images/categories/image-icon-snaks2.png') }}"
                                    alt="img-01" />
                            </div>
                    ...
                    <div class="swiper-slide">
                        <a href="# " class="cards-sm popular-categories__wrapper-item">
                            <div class="cards-sm__img-wrapper">
                                <img src="{{ asset('assets/front/images/categories/img-06.png') }}" alt="img-01" />
                            </div>
                    ...
                    <div class="swiper-slide">
                        <a href="# " class="cards-sm popular-categories__wrapper-item">
                            <div class="cards-sm__img-wrapper">
                                <img src="{{ asset('assets/front/images/categories/img-07.png') }}" alt="img-01" />
                            </div>
                    ...
                    <div class="swiper-slide">
                        <a href="# " class="cards-sm popular-categories__wrapper-item">
                            <div class="cards-sm__img-wrapper">
                                <img src="{{ asset('assets/front/images/categories/img-08.png') }}" alt="img-01" />
                            </div>
                    ...
                    <div class="swiper-slide">
                        <a href="# " class="cards-sm popular-categories__wrapper-item">
                            <div class="cards-sm__img-wrapper">
                                <img src="{{ asset('assets/front/images/categories/image-soda.png') }}" alt="img-01" />
                            </div>
                    ...
                    <div class="swiper-slide">
                        <a href="# " class="cards-sm popular-categories__wrapper-item">
                            <div class="cards-sm__img-wrapper">
                                <img src="{{ asset('assets/front/images/categories/image-oil.png') }}" alt="img-01" />
                            </div>
    ...
    <section class="popular-products section section--md">
        <div class="container">
            <div class="section__head">
                <h2 class="section--title-one font-title--sm">{{ __('front.popular_products') }}</h2>
            </div>

            <!-- Desktop Versions -->
            <div class="popular-products__wrapper">
                @foreach ($popularProducts as $popularProduct)
                    <x-front.product-item :product="$popularProduct" />
                @endforeach
            </div>
            ...
            <div class="swiper-container popular-products--slider">
                <div class="swiper-wrapper">
                    @foreach ($popularProducts as $popularProduct)
                        <div class="swiper-slide">
                            <x-front.product-item :product="$popularProduct" class="w-100" />
                        </div>
                    @endforeach
                </div>
                <div class="swiper-pagination"></div>
    ...
    <section class="deals section--gray section--lg">
        <div class="container">
            <div class="section__head">
                <h2 class="section--title-one font-title--sm">{{ __('front.recently_added_products') }}</h2>
            </div>
            <div class="swiper-container featured-slider--one">
                <div class="swiper-wrapper">
                    @foreach ($lastProducts as $lastProduct)
                        <div class="swiper-slide">
                            <x-front.product-item :product="$lastProduct" class="w-100" />
                        </div>
                    @endforeach
                </div>
