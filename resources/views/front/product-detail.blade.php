...
@section('meta')
    <meta name="description" content="{{ isset($product) ? $product->seo_description : '' }}">
    <meta name="keywords" content="{{ isset($product) ? $product->seo_keywords : '' }}">
@endsection
@section('css')
@endsection
@push('style')
                ...
                <div class="col-lg-6">
                    ...
                    <div class="gallery-view">
                        ...
                        <div class="gallery-main-image products__gallery-img--lg">
                            <img class="product-main-image" src="{{ asset($firstImg ?? '') }}" alt="{{ $product->name }}" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="products__content">
                        ...
                        <div class="products__content-price">
                            <h2 class="font-body--xxxl-500">{{ getMoneyFormat($product->price) }} <span
                                    class="font-body--md-500">TL</span></h2>
                        </div>
                    </div>
                    <!-- brand  -->
                    <div class="products__content">
                        <div class="products__content-brand">
                            <div class="brand-name">
                                <h2 class="font-body--md-400">Marka:</h2>
                                <a href="#" class="brand-name-logo">
                                    {{ $product->brand->name }}
                                </a>
                            </div>
                            <div class="social-site">
                                <h2 class="font-body--md-400">Paylaş:</h2>
                        ...
                        <p class="products__content-brand-info font-body--md-400">
                            {{ Str::of(strip_tags($product->content))->limit(100) }}
                        </p>
                    </div>
                    <!-- Action button -->
                    <div class="products__content">
                        <div class="products__content-action">
                            <div class="counter-btn-wrapper products__content-action-item">
                                ...
                                <input type="number" id="counter-btn-counter" class="counter-btn-counter" min="0"
                    ...
                    <!-- Tags  -->
                    <div class="products__content">
                        <h5 class="products__content-category font-body--md-500">{{ Str::ucfirst(__('route.category')) }}:
                            <a
                                href="{{ route('front.categoryProductList', ['category' => $catSlug]) }}">{{ $category->name }}</a>
                        </h5>
                    </div>
                </div>
            </div>
