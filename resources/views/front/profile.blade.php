                    ...
                    <div class="container">
                            ...
                            <div class="col-lg-7">
                                <div class="dashboard__user-profile dashboard-card">
                                    <div class="dashboard__user-profile-img">
                                        <img src="{{ asset('assets/front/images/user/img-07.png') }}" alt="userImg" />
                                    </div>
                                    <div class="dashboard__user-profile-info">
                                        <h5 class="font-body--xxl-500 name">{{ $user->name }}</h5>
                                        <p class="font-body--md-400 designation">Müşteri</p>
                        ...
                        <div class="dashboard__order-history" style="margin-top: 24px">
                            <div class="dashboard__order-history-title">
                                <h2 class="font-body--xxl-500">Son 5 Siparişiniz</h2>
                                <a href="{{ route('front.profile.orders') }}" class="font-body--lg-500">
                                    Tümünü Gör</a>
                            </div>
