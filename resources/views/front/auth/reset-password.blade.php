...
@section('meta')
    <meta name="description" content="Şifremi Unuttum">
    <meta name="keywords" content="Şifremi Unuttum">
@endsection
@section('css')
@endsection
@push('style')
    ...
    <section class="sign-in section section--xl">
        <div class="container">
            <div class="form-wrapper">
                <h6 class="font-title--sm">{{ __('front.reset_password') }}</h6>

                @include('layouts.partials.errors')
                @include('layouts.partials.alert')

                <form
                    action="{{ isset($token) ? route('front.passwordResetToken', ['token' => $token]) : route('front.passwordReset') }}"
                    method="post">
                    @csrf
                    ...
                    @isset($token)
                        ...
                        <div class="form-input">
                            <input type="password" name="confirm_password" placeholder="Parola Tekrar" id="confirmPassword"
                                required />
                    ...
                    <div class="form-button">
                        <button class="button button--md w-100">{{ __('front.reset_password') }}</button>
                    </div>
                </form>
            </div>
        </div>
