    ...
    <section class="sign-in section section--xl">
        <div class="container">
            <div class="form-wrapper">
                <h6 class="font-title--sm">{{ __('front.login') }}</h6>
                ...
                <form action="{{ route('front.login') }}" method="post">
                    ...
                    <div class="form-input">
                        <input type="password" name="password" required placeholder="Parola" id="password" />
                    ...
                    <div class="form-wrapper__content">
                        ...
                        <a href="{{ route('front.passwordReset') }}">Şifremi Unuttum</a>
                    </div>
                    <div class="form-button">
                        <button class="button button--md w-100">{{ __('front.login') }}</button>
                    </div>
                    <div class="form-register">
                        Üyeliğin Yoksa <a href="{{ route('front.register') }}">Üye Ol</a>
                    </div>
                </form>
            </div>
        </div>
