    ...
    <section class="create-account section section--xl">
        <div class="container">
            <div class="form-wrapper">
                <h6 class="font-title--sm">{{ __('front.register') }}</h6>
                ...
                <form action="{{ route('front.register') }}" method="post">
                    ...
                    <div class="form-button">
                        <button class="button button--md w-100">{{ __('front.register') }}</button>
                    </div>
                    <div class="form-register">
                        Üye misiniz? <a href="{{ route('front.login') }}">Giriş Yapın</a>
                    </div>
                </form>
            </div>
        </div>
