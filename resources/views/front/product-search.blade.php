...
@section('meta')
    <meta name="description" content="{{ isset($item) ? $item->seo_description : 'Ara' }}">
    <meta name="keywords" content="{{ isset($item) ? $item->seo_keywords : 'Ara' }}">
@endsection
@section('css')
@endsection
@push('style')
                        ...
                        <div class="shop__sidebar-content">
                            <form action="" id="filterForm" method="get">
                                <div class="accordion shop" id="shop">
                                                        ...
                                                        <div class="categories-item">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="brand" id="{{ $brand->slug }}"
                                                                    value="{{ $brand->id }}"
                                                                    @checked($brand->id == request()->get('brand')) />
                                    ...
                                    <div class="accordion-item shop-item">
                                        <button type="button"
                                            class="button button--lg filterBtn">{{ __('front.filter') }}</button>
                                    </div>
                                </div>
...
@section('js')
    <script>
        ...
        $(".filterBtn").on('click', function() {
            ...
            getUrl += "&" + filterFormData;
            $.get(getUrl, function(response, textStatus, jqXHR) {
                $('#productList').html(response.data);
                window.history.pushState("", "", response.link);
            });
        });
